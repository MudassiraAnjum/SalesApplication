...
//        => optionsBuilder.UseSqlServer("Server=INBOOK_X2_SLIM\\SA;Database=SalesApplication_Db;User ID=sa;Password=user123;TrustServerCertificate=True;Trusted_Connection=true");
