...
//        => optionsBuilder.UseSqlServer("Server=LAPTOP-CADVDSBR\\SQLSERVER2022;Database=SalesApplication_Db;User ID=sa;Password=user123;TrustServerCertificate=True;Trusted_Connection=true");
