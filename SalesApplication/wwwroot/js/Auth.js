...
document.getElementById("login-form")?.addEventListener("submit", async (event) => {
    ...
    try {
        ...
        if (response.ok) {
            ...
            if (role === "Admin") {
                window.location.href = "/html/index.html"; // Redirect to admin page (index.html)
            } else if (role === "Employee") {
                window.location.href = "/html/index2.html"; // Redirect to employee page
            } else if (role === "Shipper") {
                window.location.href = "/html/index3.html"; // Redirect to shipper page
            } else {
                alert("Invalid role.");
            }
...
function checkAuthorization() {
    ...
    if (!token && (currentPath.includes("shipper.html") || currentPath.includes("employee.html") || currentPath.includes("index.html"))) {
        ...
        window.location.href = "/html/auth.html"; // Redirect to the landing/auth page
    }
}
